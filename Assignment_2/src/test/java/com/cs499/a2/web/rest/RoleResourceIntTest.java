...
public class RoleResourceIntTest {
    ...
    private static final ClassType DEFAULT_CLASS_TYPE = ClassType.BERSERKER;
    private static final ClassType UPDATED_CLASS_TYPE = ClassType.KUNOICHI;

    private static final Integer DEFAULT_LEVEL = 1;
    private static final Integer UPDATED_LEVEL = 2;

    private static final Integer DEFAULT_SP = 1;
    private static final Integer UPDATED_SP = 2;
    ...
    public void createRole() throws Exception {
        ...
        assertThat(testRole.getClassType()).isEqualTo(DEFAULT_CLASS_TYPE);
        assertThat(testRole.getLevel()).isEqualTo(DEFAULT_LEVEL);
        assertThat(testRole.getSp()).isEqualTo(DEFAULT_SP);
    }
    ...
    public void getAllRoles() throws Exception {
        ...
        restRoleMockMvc.perform(get("/api/roles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sp").value(hasItem(DEFAULT_SP)));
    }
    ...
    public void getRole() throws Exception {
        ...
        restRoleMockMvc.perform(get("/api/roles/{id}", role.getId()))
            ...
            .andExpect(jsonPath("$.sp").value(DEFAULT_SP));
    }
    ...
    public void updateRole() throws Exception {
        ...
        Role testRole = roleList.get(roleList.size() - 1);
        assertThat(testRole.getClassType()).isEqualTo(UPDATED_CLASS_TYPE);
        assertThat(testRole.getLevel()).isEqualTo(UPDATED_LEVEL);
        assertThat(testRole.getSp()).isEqualTo(UPDATED_SP);
    }
